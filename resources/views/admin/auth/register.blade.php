...
@section('content')
            ...
            <div class="panel-heading"> 
                <h3 class="text-center"> <strong class="text-custom">BUKULAPUK</strong> ADMIN REGISTER </h3>
            </div> 
            ...
            <form class="form-horizontal m-t-20" role="form" method="POST" action="{{ url('/admin/register') }}">
                ...
                <div class="col-sm-12 text-center">
                    <p>have an account? <a href="{{ url('/admin/login') }}" class="text-primary m-l-5"><b>Login</b></a></p>      
                    </div>
            </div>
