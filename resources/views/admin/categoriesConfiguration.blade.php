<?php 
$title='BUKULAPUK - Konfigurasi Kategori';
$page_title='Konfigurasi Kategori';
$page_desc='Konfigurasikan Kategori pada Marketplace';
?>
...
@section('content')
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Konfigurasi Kategori</b></h4>
                                   ...
                                   <table id="demo-foo-accordion" class="table m-b-0 toggle-arrow-tiny">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 text-xs-center">
                                                    <div class="form-group">
                                                        <button  id="demo-btn-addrow"class="btn btn-default m-b-20" data-toggle="modal" data-target="#add_category" ><i class="fa fa-plus m-r-5"></i> Tambah Kategori</button>
                                                    </div>
                                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <button class="demo-delete-row btn btn-warning btn-xs btn-icon fa fa-cog" onclick="edit({{$category->id}})"></button>
                                                &nbsp;
                                               <a href="/admin/categories/delete/{{$category->id}}"><button class="btn btn-danger btn-xs btn-icon fa fa-times"></button></a>
                                                &nbsp;
                                                <a href="/admin/show/categories/{{$category->id}}"><button class="btn btn-basic btn-xs btn-icon fa fa-table"></button></a></td>
                                            </tr>                                                
                                            </tr>
                                            @endforeach
                                        </tbody>
...
<!-- Modal ADD -->
                ...
                <div id="add_category" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                         {{ Form::open(array('id'=>'addCategoryForm','url'=>'/admin/configuration/categories')) }}
...
<!--Start Modal Edit -->
                ...
                <div id="edit_category" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        {{ Form::open(array('id'=>'editCategoryForm','url'=>'/admin/configuration/categories/edit')) }}
                                        <div class="modal-dialog"> 
                                            <div class="modal-content"> 
                                                <div class="modal-header"> 
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
