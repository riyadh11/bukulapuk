<?php
$title='BUKULAPUK - Monitor Produk';
$page_title='Monitor Produk';
$page_desc='Monitoring Produk di Marketplace';
?>
...
@section('content')
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Monitoring Produk</b></h4>
                                    <p class="text-muted m-b-30 font-13">
                                       Monitoring Produk yang belum aktif
                                    </p>
                                    ...
                                    <table id="demo-foo-accordion" class="table m-b-0 toggle-arrow-tiny">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                &nbsp;
                                                <a href="/admin/products/active/{{$Product->id}}"><button class="btn btn-success btn-xs btn-icon fa fa-check"></button></a>
                                                &nbsp;
                                            </tr>
                                            @endforeach
                                        </tbody>
