                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown top-menu-item-xs">
                                    <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="/assets/images/users{{DB::table('bios')->where('id',Auth::guard('admin')->user()->bio)->first()->img}}" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#" onclick="logout()"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
